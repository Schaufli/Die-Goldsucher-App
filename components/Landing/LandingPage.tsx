    ...
    <div className="min-h-screen bg-[#FDFBF7] text-stone-800 font-sans selection:bg-amber-500/30 selection:text-stone-900">
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <a href="/" className="bg-amber-500 hover:bg-amber-600 text-stone-900 px-6 py-2 rounded font-bold transition-all hover:scale-105 shadow-[0_0_15px_rgba(245,158,11,0.5)]">
              App Öffnen
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="/" className="bg-amber-500 hover:bg-amber-600 text-stone-900 px-8 py-4 rounded font-bold text-lg transition-all hover:scale-105 shadow-[0_4px_20px_rgba(245,158,11,0.4)] flex items-center justify-center gap-2 group no-underline">
                Jetzt Expedition Starten
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <button onClick={scrollToFeatures} className="bg-stone-800/60 hover:bg-stone-800 backdrop-blur-md text-white border border-stone-600 px-8 py-4 rounded font-bold text-lg transition-all flex items-center justify-center gap-2">
                Mehr Erfahren
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="space-y-10">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-stone-900 mb-3">Interaktive Fundort-Karte</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-stone-900 mb-3">Intelligente Filterung</h3>
                  <p className="text-stone-600 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-stone-900 mb-3">Eigene Kategorien erstellen</h3>
                  <p className="text-stone-600 leading-relaxed">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2 relative">
              ...
              <img 
                src="/images/goldsucher-journal.png" 
                alt="Feldtagebuch mit Goldflakes" 
      ...
      <section className="py-24 bg-[#EBE5D9] text-stone-900 border-y border-stone-300">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <blockquote className="text-2xl md:text-4xl font-medium leading-relaxed mb-8 text-stone-800">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="/" className="bg-amber-500 hover:bg-amber-600 text-stone-900 px-10 py-4 rounded font-bold text-lg transition-all hover:scale-105 shadow-[0_4px_20px_rgba(245,158,11,0.4)] no-underline">
          ...
          <div className="border-t border-stone-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2 text-stone-400">
              ...
              <span className="font-bold tracking-wide">GOLDSUCHER</span>
            </div>
